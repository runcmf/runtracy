 ...
 */
class SlimContainerTest extends BaseTestCase
{
    public function testSlimContainer()
    {
        ...
        // test Tracy tab
        $this->assertRegexp('#Slim Container#', $panel->getTab());
        // test Tracy panel
        $this->assertRegexp('#Container:#', $panel->getPanel());
    }
}
